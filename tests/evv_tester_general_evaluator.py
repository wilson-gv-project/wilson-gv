...
def run():
    ...
    if not PREP_ONLY:
        from wilson_suite.wilson_intensities.amplitudes.evaluators import terms_evaluator_general
        logger.info('  >>> Going to evaluate now...\n')
        sim.evaluateAsResponseFunction(evaluator=terms_evaluator_general)

...
#
# Qab = get_abc(2, len(h.fundamentals))
# Qabc = get_abc(3, len(h.fundamentals))

# print(Qabc)

# h.plot2D(Qab=[], Qabc=Qabc, w1mw2=False)

#
# t = {100: [0., 2., 1.1, 2.3, 4.1], 110: [0.7, 1., 2.1, 3.3, 5.1], 111: [1.7, 1.6, 1.1, 3.7, 5.4],
#      115: [2.7, 3.6, 4.1, 6.7, 9.4], 125: [12.7, 13.6, 14.1, 16.7, 19.4]}
# # print(t)
#
# import numpy as np
# dd = np.array([
...
#     [1.7, 1.6, 1.1, 3.7, 5.4],
#     [2.7, 3.6, 4.1, 6.7, 9.4],
#     [12.7, 13.6, 14.1, 16.7, 19.4]
# ])
#
# import pandas as pd
# # pddf = pd.DataFrame(t, index=t.keys())
# pddf = pd.DataFrame(dd)
#
# # print(pddf)
#
# def spectrinDF():

...
def make_texts4fig(input_data_info: dict, computedSpectrum, artist, settings: dict, other: dict, directory: str = '.'):
    terms_selection = other['terms_selection']
...
def make_name(input_data_info: dict, vib_levels_harmonic, settings: dict, other: dict, directory: str = '.'):
    w1mw2 = other['w1mw2']
    regions = other['regions']

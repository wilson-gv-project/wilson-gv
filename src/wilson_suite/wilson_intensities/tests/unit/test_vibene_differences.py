...
def test_calculate_vibenedenom_tensor():
    ...
    nc_sqrt_eigval = {0: 970., 1: 1264., 2: 3662.}
    ...
    assert np.allclose(vibenedenom_tensor3d[0, 0, 0] , 1./ convNu2Ene(970.)**3)
    assert np.allclose(vibenedenom_tensor3d[0, 1, 2] , 1./ (convNu2Ene(970.)*convNu2Ene(1264.)*convNu2Ene(3662.)))
    assert np.allclose(vibenedenom_tensor3d[0, 1, 1] , 1./ (convNu2Ene(970.)*convNu2Ene(1264.)**2))
